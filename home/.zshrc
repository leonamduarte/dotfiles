...
# Preserve existing SDKMAN and Android SDK settings
...
# ------------------------------------------------------------------
# Converted aliases and helpers from fish config
# ------------------------------------------------------------------
...
# zoxide (if available) - replicate fish behaviour
...
alias cdg='cd ~/.config'
alias cddev='cd ~/'
## removed: alias to non-existing path
# alias cdaula='cd ~/gitlab/maisPraTi/'
