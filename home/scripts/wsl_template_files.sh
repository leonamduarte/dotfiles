#!/bin/bash
# File Templates Creation Script for WSL (Fedora)

# Set variables
ACTUAL_USER=$SUDO_USER
ACTUAL_HOME=$(eval echo ~$SUDO_USER)
TEMPLATES_DIR="$ACTUAL_HOME/Templates"
LOG_FILE="/var/log/wsl_file_templates.log"
...
echo "These templates can be used in file managers that support FreeDesktop.org templates."
echo "The templates will appear as an option when creating new files."
echo "";
