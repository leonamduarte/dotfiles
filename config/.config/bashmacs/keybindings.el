...
(defun bashln/reload-config ()
  "Reload the entire Emacs configuration."
  (interactive)
  (load-file user-init-file)
  (message "Config reloaded successfully."))

(defun bashln/consult-ripgrep-smart ()
  (interactive)
  (if (project-current)
...
(bashln/leader-keys
 ...
 "h r r" '(bashln/reload-config :which-key "Reload config")
 ...
 "m i" '(bashln/org-insert-auto-tangle-tag :which-key "insert auto_tangle")
 
 ;; Doom-style global search
 "/" '(bashln/consult-ripgrep-smart :which-key "search")
