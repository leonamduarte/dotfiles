...
(save-place-mode 1)   ;; lembra posição no arquivo
(savehist-mode 1)     ;; histórico do minibuffer
(recentf-mode 1)      ;; arquivos recentes
...
;; salva recentf periodicamente (evita perder histórico)
